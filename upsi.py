...
def jahresverbrauch_berechnung(erdgas_verbrauch, strom_verbrauch):
    ...
    #              position="G12", chart_type=72, titel="Jährliche Kostenannahmen")
...
if __name__ == "__main__":
    ...
    matrix_datei = pd.read_excel(io="/Users/aochoa/PycharmProjects/Fraunhofer/Mainova_VersionAOF.xlsm",
                                 sheet_name="WGK_Kopie", header=0, index_col=[0, 1, 2])
